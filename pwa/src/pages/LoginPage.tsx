...
export function LoginPage() {
    ...
    const handleForgotPassword = async () => {
        if (!email) {
            setError('Wpisz email, aby zresetować hasło');
            return;
        }
        setError('');
        setLoading(true);
        try {
            ...
            setError('Nie udało się wysłać emaila z resetem hasła');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            <Card className="w-full max-w-md">
                <CardHeader className="text-center space-y-2">
                    ...
                    <CardTitle className="text-3xl text-primary">Mocni60+</CardTitle>
                    <p className="text-lg text-muted-foreground">Zaloguj się do swojego konta</p>
                </CardHeader>
                    ...
                    {resetSent && (
                        <div className="bg-green-50 border border-green-200 rounded-xl p-4">
                            <p className="text-green-800 text-lg">
                                Email z linkiem do resetu hasła został wysłany na {email}
                            </p>
                        </div>
                    )}
